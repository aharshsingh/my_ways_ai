...
const deleteUser=async(fetchUsers,userId)=>{
    try {
...
export default function DeleteUser({ testId,isOpen, setIsOpen,fetchTests }) {
  return (
   <>
      ...
      <AlertDialogContent>
        <AlertDialogHeader className="mb-4 items-center gap-2 md:flex-row md:items-start md:gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <AlertDialogDescription>
              Deleting a User is irreversible and will erase all User
