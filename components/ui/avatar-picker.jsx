...
export function AvatarPicker({username,email}) {
            ...
            <Card
                ...
                <CardContent className="p-0">
                    ...
                    <div className="px-8 pb-8 -mt-16">
                        ...
                        {/* Avatar selection */}
                        <motion.div className="mt-6 flex flex-col items-center justify-center" variants={pickerVariants.container}>
                            <motion.div className="flex justify-center items-center gap-4" variants={pickerVariants.container}>
                                {avatars.map((avatar) => (
                                    <motion.button
                                        key={avatar.id}
                                        onClick={() =>
