...
function Slot(props) {
  ...
  return (
    ...
    {showOtpContent ? 
    <DialogContent  className=" w-[30rem] h-[20rem] p-5">
       <DialogHeader>
          ...
          <div className="space-y-5 items-center justify-center flex flex-col">
            ...
            <Button type="button" className="w-[50%] bg-[#5862b2] hover:bg-[#5862b2]">
            Submit
          </Button>
      ...
      <DialogContent className="w-[30rem] h-[20rem] p-5">
       ...
       <svg
        ...
        <form className="space-y-5">
          ...
          <Button onClick={()=>setShowOtpContent(true)} type="button" className="w-full bg-[#5862b2] hover:bg-[#5862b2]">
            Get OTP
          </Button>
        </form>
      </DialogContent>}
